...
from noblecrm import http, models, fields, _
from noblecrm.http import request
from noblecrm.tools import pycompat, OrderedSet
from noblecrm.addons.http_routing.models.ir_http import slug, _guess_mimetype
from noblecrm.addons.web.controllers.main import WebClient, Binary
from noblecrm.addons.portal.controllers.portal import pager as portal_pager
from noblecrm.addons.portal.controllers.web import Home
...
class Website(Home):
    ...
    def website_info(self):
        ...
        values = {
            'apps': apps,
            'modules': modules,
            'version': noblecrm.service.common.exp_version()
        }
