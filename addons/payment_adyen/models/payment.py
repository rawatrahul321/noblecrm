...
from noblecrm.addons.payment_adyen.controllers.main import AdyenController
from noblecrm.tools.pycompat import to_native
...
class AcquirerAdyen(models.Model):
    ...
    def _adyen_generate_merchant_sig_sha256(self, inout, values):
        ...
        :param string inout: 'in' (noblecrm contacting ogone) or 'out' (adyen
