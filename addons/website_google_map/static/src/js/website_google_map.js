function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('noblecrm-google-map'), {
        zoom: 1,
    ...
    if (noblecrm_partner_data){ /* noblecrm_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < noblecrm_partner_data.counter; i++) {
            set_marker(noblecrm_partner_data.partners[i]);
        }
