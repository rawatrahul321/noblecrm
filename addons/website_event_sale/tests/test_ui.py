...
class TestUi(noblecrm.tests.HttpCase):
    ...
    def test_admin(self):
        ...
        self.phantom_js("/", "noblecrm.__DEBUG__.services['web_tour.tour'].run('event_buy_tickets')", "noblecrm.__DEBUG__.services['web_tour.tour'].tours.event_buy_tickets.ready", login="admin")

    def test_demo(self):
        self.phantom_js("/", "noblecrm.__DEBUG__.services['web_tour.tour'].run('event_buy_tickets')", "noblecrm.__DEBUG__.services['web_tour.tour'].tours.event_buy_tickets.ready", login="demo")
