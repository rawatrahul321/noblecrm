define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // NOBLECRM: allow access for override
    this.table = table;   // NOBLECRM: allow access for override
    this.typing = typing; // NOBLECRM: allow access for override
    this.bullet = bullet; // NOBLECRM: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // NOBLECRM: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // NOBLECRM: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // NOBLECRM: adding this branch to modify existing anchor if it fully contains the range
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // NOBLECRM: addition
        $(anchor).css(linkInfo.style || {}); // NOBLECRM: addition
        if (isNewWindow) {
