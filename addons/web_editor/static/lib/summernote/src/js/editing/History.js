define(['summernote/core/range', 'summernote/core/dom'], function (range, dom) { // NOBLECRM: suggest upstream
  /**
  ...
  var History = function ($editable) {
    ...
    var makeSnapshot = function () {
      ...
      return {
        ...
        // NOBLECRM: suggest upstream added " && dom.ancestor(rng.sc, dom.isEditable) "
      };
    };
    ...
    var last; // NOBLECRM: to suggest upstream (since we may have several editor)
    /**
     * recorded undo
     */
    this.recordUndo = function () {
      // NOBLECRM: method totally rewritten
