noblecrm.define('web_editor.iframe', function (require) {
'use strict';
...
window.top.noblecrm[callback + '_updown'] = function (value, fields_values, field_name) {
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.noblecrm[callback + '_editor']) {
                window.top.noblecrm[callback + '_editor'](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.noblecrm[callback + '_downup']) {
                    window.top.noblecrm[callback + '_downup']($editable.prop('innerHTML'));
                }
            });
        });
...
noblecrm.define('web_editor.IframeRoot.instance', function (require) {
'use strict';
...
noblecrm.define('web_editor.IframeRoot', function (require) {
'use strict';
