...
Also, adds methods to convert values back to NobleCRM models.
"""
...
import noblecrm.modules

from noblecrm import api, models, fields
from noblecrm.tools import ustr, pycompat
from noblecrm.tools import html_escape as escape
from noblecrm.addons.base.ir import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = noblecrm.modules.get_module_resource(
