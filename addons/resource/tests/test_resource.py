...
from noblecrm.fields import Date, Datetime
from noblecrm.addons.resource.models.resource import to_naive_utc, to_naive_user_tz
from noblecrm.addons.resource.tests.common import TestResourceCommon
