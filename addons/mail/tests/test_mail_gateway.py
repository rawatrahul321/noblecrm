...
To: {to}
cc: {cc}
Received: by mail1.noblecrmerp.com (Postfix, from userid 10002)
...
Received: from mail-ie0-f173.google.com (mail-ie0-f173.google.com [209.85.223.173])
    ...
    for <raoul@noblecrmerp.fr>; Fri, 23 Aug 2013 13:17:55 +0200 (CEST)
...
From: Anon <anon@infonoble.com>
To: anon@gmail.com
References: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@infonoble.com>
Message-ID: <cb7eaf62-58dc-2017-148c-305d0c78892f@infonoble.com>
Date: Wed, 14 Mar 2018 14:26:58 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.6.0
MIME-Version: 1.0
In-Reply-To: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@infonoble.com>
Content-Type: multipart/mixed;
...
Delivered-To: anon2@gmail1.noblecrmerp.com
...
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@infonoble.com header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@infonoble.com designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@infonoble.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=infonoble.com
Return-Path: <soup@infonoble.com>
Received: from mail2.infonoble.com (mail2.infonoble.com. [149.202.180.44])
        by mx.google.com with ESMTPS id y4si4279200wmy.148.2018.03.05.01.19.22
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 05 Mar 2018 01:19:23 -0800 (PST)
Received-SPF: pass (google.com: domain of soup@infonoble.com designates 149.202.180.44 as permitted sender) client-ip=149.202.180.44;
...
Received: from [10.10.31.24] (unknown [91.183.114.50])
	...
	by mail2.infonoble.com (Postfix) with ESMTPSA id 7B571A4085
	for <what@infonoble.com>; Mon,  5 Mar 2018 10:19:21 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=infonoble.com; s=mail;
...
To: what@infonoble.com
From: Soup <soup@infonoble.com>
Subject: =?UTF-8?Q?Soupe_du_jour_:_Pois_cass=c3=a9s?=
Message-ID: <a05d8334-7b7c-df68-c96a-4a88ed19f31b@infonoble.com>
...
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on mail2.infonoble.com
...
Chaussée de Namur, 40
B-1367 Grand Rosière
Web: <a class="moz-txt-link-freetext" href="http://www.infonoble.com">http://www.infonoble.com</a> </pre>
  </body>
</html>
...
In-Reply-To: <829228111124527.1111111602.256611118262939-noblecrmerp-129-xxxx.xxxx@ip-1-1-1-1>
References: <867911111953277.1523671337.187951111160400-noblecrmerp-129-xxxx.xxxx@ip-1-1-1-1>
 <867911111953277.1523671337.256611118262939-noblecrmerp-129-xxxx.xxxx@ip-1-1-1-1>
...
.256660938262939-noblecrmerp-129-xxxx.xxxx@ip-1-1-1-1" type=3D"cite"=
 class=3D"cite2">
...
.com" style=3D"text-decoration:none; color: white;">
                      ...
                      <tr>
                        <td align=3D"center">
                            Powered by <a href=3D"https://www.infonoble.com">Odo=
o</a>.
                        </td>
                      </tr>
                    </tbody>
...
class TestMailgateway(TestMail):
    ...
    def setUp(self):
        ...
        self.fake_email = self.env['mail.message'].create({
            ...
            'message_id': '<123456-noblecrmerp-%s-mail.test@%s>' % (self.test_public.id, socket.gethostname()),
        })

    @mute_logger('noblecrm.addons.mail.models.mail_thread')
    ...
    @mute_logger('noblecrm.addons.mail.models.mail_thread', 'noblecrm.models')
    ...
    @mute_logger('noblecrm.addons.mail.models.mail_thread', 'noblecrm.models', 'noblecrm.addons.mail.models.mail_mail')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by noblecrm should update thread accordingly """
    ...
    def test_message_process_model_res_id(self):
        """ Incoming email with ref holding model / res_id but that does not match any message in the thread: must raise since NobleCRMerp saas-3 """
        self.assertRaises(ValueError,
                          self.format_and_process,
                          MAIL_TEMPLATE, email_from='valid.lelitre@agrolait.com',
                          to='noone@example.com', subject='spam',
                          extra='In-Reply-To: <12321321-noblecrmerp-%d-mail.test@%s>' % (self.test_public.id, socket.gethostname()),
                          msg_id='<1198923581.41972151344608186802.JavaMail.diff1@agrolait.com>')

        # when 6.1 messages are present, compat mode is available
        # NobleCRM 10 update: compat mode has been removed and should not work anymore
        ...
        # NobleCRM 10 update: compat mode has been removed and should not work anymore and does not depend from hostname
        self.assertRaises(ValueError,
                          self.format_and_process,
                          MAIL_TEMPLATE, email_from='other5@gmail.com',
                          msg_id='<1.3.JavaMail.new@agrolait.com>',
                          to='noone@example.com>', subject='spam',
                          extra='In-Reply-To: <12321321-noblecrmerp-%d-mail.test@neighbor.com>' % self.test_public.id)
    ...
    def test_private_discussion(self):
        ...
        # Test: message-id
        self.assertIn('noblecrmerp-private', msg.message_id, 'message_post: private discussion: message-id should contain the private keyword')
    ...
    def test_forward_parent_id(self):
        ...
        # tmp
        from noblecrm.addons.mail.tests.test_mail_model import MailTest
