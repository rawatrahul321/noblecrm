...
from noblecrm.addons.base.ir.ir_mail_server import MailDeliveryException
        ...
        for server_id, batch_ids in self._split_by_server():
            ...
            try:
                ...
                if raise_exception:
                    ...
                    # exceptions, it is encapsulated into an NobleCRM MailDeliveryException
    ...
    def _send(self, auto_commit=False, raise_exception=False, smtp_session=None):
        ...
        for mail_id in self.ids:
            try:
                ...
                # see revid:odo@noblecrmerp.com-20120622152536-42b2s28lvdv3odyr in 6.1
                if mail_sent:
