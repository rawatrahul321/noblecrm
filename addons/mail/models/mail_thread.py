...
from noblecrm import _, api, exceptions, fields, models, tools
...
class MailThread(models.AbstractModel):
    ...
    def message_get_email_values(self, notif_mail=None):
        ...
        return {'headers': repr({
            'X-NobleCRM-Objects': "%s-%s" % (self._name, self.id),
            'X-NobleCRM-db-uuid': database_uuid
        })}
   ...
   Only allowed people can contact us at this address.</p>
    ...
    def message_route(self, message, message_dict, model=None, thread_id=None, custom_values=None):
         ...
         * if the message replies to an existing thread by having In-Reply-To or
           References matching noblecrm model/thread_id Message-Id and if this thread
    ...
    def _message_get_auto_subscribe_fields(self, updated_fields, auto_follow_fields=None):
        """ Returns the list of relational fields linking to res.users that should
            ...
            In NobleCRMerp V7, this is sufficent for all major addon such as opportunity,
