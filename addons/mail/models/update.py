...
from noblecrm import api, release, SUPERUSER_ID
from noblecrm.exceptions import UserError
from noblecrm.models import AbstractModel
from noblecrm.tools.translate import _
from noblecrm.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to NobleCRM's publisher warranty server to check the
