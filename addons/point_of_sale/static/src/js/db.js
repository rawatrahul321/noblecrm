noblecrm.define('point_of_sale.DB', function (require) {
"use strict";
...
var PosDB = core.Class.extend({
    name: 'noblecrmerp_pos_db', //the prefix of the localstorage data
     ...
     * returned by the noblecrmerp server. Categories must be inserted before the products or the 
