noblecrm.define('point_of_sale.models', function (require) {
"use strict";
...
// Loads noblecrmerp models at the point of sale startup.
// load_models take an array of model loader declarations.
// - The models will be loaded in the array order. 
// - If no noblecrmerp model name is provided, no server data
...
//
// models: [{
//  model: [string] the name of the noblecrmerp model to load.
...
//  context: [Dict|function] the noblecrmerp context for the model read
