noblecrm.define('point_of_sale.screens', function (require) {
"use strict";
...
var OrderWidget = PosBaseWidget.extend({
    ...
    // overriding the noblecrmerp framework replace method for performance reasons
    ...
    finalize_validation: function() {
        ...
        if (order.is_to_invoice()) {
            ...
            invoiced.fail(function(error){
                ...
                } else if (error.code === 200) {    // NobleCRMerp Server Errors
