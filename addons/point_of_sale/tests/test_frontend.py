...
from noblecrm.tools import DEFAULT_SERVER_DATE_FORMAT
...
class TestUi(noblecrm.tests.HttpCase):
    def test_01_pos_basic_order(self):
        ...
        self.phantom_js("/pos/web",
                        "noblecrm.__DEBUG__.services['web_tour.tour'].run('pos_pricelist')",
                        "noblecrm.__DEBUG__.services['web_tour.tour'].tours.pos_pricelist.ready",
                        login="admin")

        self.phantom_js("/pos/web",
                        "noblecrm.__DEBUG__.services['web_tour.tour'].run('pos_basic_order')",
                        "noblecrm.__DEBUG__.services['web_tour.tour'].tours.pos_basic_order.ready",
                        login="admin")
