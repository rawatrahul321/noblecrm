...
VERSION=11.0
REPO=https://github.com/noblecrm/noblecrm.git
...
CLONE_DIR="${OVERWRITE_FILES_BEFORE_INIT_DIR}/home/pi/noblecrm"
...
noblecrm/
noblecrm-bin" | tee --append .git/info/sparse-checkout > /dev/null
