...
from noblecrm.tools.float_utils import float_compare, float_is_zero, float_round
from noblecrm.exceptions import UserError
from noblecrm.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        'Show Reserved', default=True, help="If this checkbox is ticked, NobleCRM will show which products are reserved (lot/serial number, source location, source package).")
