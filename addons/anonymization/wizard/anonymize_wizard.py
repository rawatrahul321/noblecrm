...
from noblecrm.release import version_info
from noblecrm.tools import pickle
from noblecrm.tools.safe_eval import safe_eval
from noblecrm.addons.anonymization.models.anonymization import group
...
class IrModelFieldsAnonymizeWizard(models.TransientModel):
    ...
    def anonymize_database(self):
        ...
        raise UserError("""The NobleCRM Migration Platform no longer accepts anonymized databases.\n
            If you wish for your data to remain private during migration, please contact us at upgrade@infonoble.com""")
        self.ensure_one()
