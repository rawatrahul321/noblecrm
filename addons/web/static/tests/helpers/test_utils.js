noblecrm.define('web.test_utils', function (require) {
"use strict";
 ...
 * not fire.
 *
 * @param {Widget} widget the target widget (any NobleCRM widget)
 ...
 *   the DOM. Also, the logLevel will be forced to 2 and the uncaught NobleCRMEvent
 *   will be logged
...
function createAsyncView(params) {
    ...
    // make sure all NobleCRM events bubbling up are intercepted
 ...
 *   used to generate mock answers for every kind of routes supported by noblecrm
