noblecrm.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. NobleCRM JS views are the
 ...
 * the word 'view' has historical significance in NobleCRM code, so we replaced the
...
noblecrm.define('web.viewUtils', function () {
"use strict";
