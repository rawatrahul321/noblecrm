noblecrm.define('web.upgrade_widgets', function (require) {
"use strict";
...
var AbstractFieldUpgrade = {
    ...
    /**
     * Redirects the user to the noblecrm-enterprise/uprade page
     *
     * @private
     * @returns {Deferred}
     */
    _confirmUpgrade: function () {
        return this._rpc({
            ...
            .then(function (data) {
                framework.redirect("https://www.infonoble.com/noblecrm-enterprise/upgrade?num_users=" + data);
            });
    },
    /**
