noblecrm.define('web.CrashManager', function (require) {
"use strict";
...
var CrashManager = core.Class.extend({
    ...
    rpc_error: function(error) {
        ...
        if (error.data.name === "noblecrm.http.SessionExpiredException" || error.data.name === "werkzeug.exceptions.Forbidden") {
            this.show_warning({type: _t("NobleCRM Session Expired"), data: {message: _t("Your NobleCRM session expired. Please refresh the current web page.")}});
            return;
        }
    ...
    show_warning: function(error) {
        ...
        return new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type || error.message) || _t("NobleCRM Warning"),
    ...
    show_error: function(error) {
        ...
        var dialog = new Dialog(this, {
            title: _.str.capitalize(error.type || error.message) || _t("NobleCRM Error"),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type) || _t("NobleCRM Warning"),
            buttons: [
...
core.crash_registry.add('noblecrm.exceptions.RedirectWarning', RedirectWarningHandler);

return CrashManager;
});

noblecrm.define('web.crash_manager', function (require) {
"use strict";
