noblecrm.define('web.ActionManager', function (require) {
"use strict";

/**
 * ActionManager
 *
 * The action manager is quite important: it makes sure that actions (the NobleCRM
...
var ActionManager = Widget.extend({
     ...
     *
     * @param {Widget} widget typically, widgets added are noblecrmerp.web.ViewManager. The action manager uses the stack of actions to handle the breadcrumbs.
