noblecrm.define('web.search_inputs', function (require) {
"use strict";
...
/**
 * Implementation of the ``char`` NobleCRMerp field type:
 *
...
/**
 * Implementation of the ``datetime`` noblecrmerp field type:
 *
...
var FilterGroup = Input.extend(/** @lends instance.web.search.FilterGroup# */{
     ...
     *
     * @param {noblecrmerp.web.search.Facet} facet
...
var Filter = Input.extend(/** @lends instance.web.search.Filter# */{
    ...
    /**
     * Implementation of the NobleCRMerp filters (button with a context and/or
