noblecrm.define('web.SearchView', function (require) {
"use strict";
...
var SearchView = Widget.extend({
    ...
    /**
     * @param {noblecrmerp.web.search.SearchQuery | undefined} collection Undefined if event is change
     * @param {noblecrmerp.web.search.Facet} model
     * @param {Object} [options]
     */
