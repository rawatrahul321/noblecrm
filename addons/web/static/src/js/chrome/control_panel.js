noblecrm.define('web.ControlPanelMixin', function (require) {
"use strict";
...
noblecrm.define('web.ControlPanel', function (require) {
"use strict";
...
var ControlPanel = Widget.extend({
     ...
     * @param {noblecrmerp.web.SearchView} [status.searchview] the searchview widget
     ...
     * @param {noblecrmerp.web.SearchView} [searchview] the searchview Widget
