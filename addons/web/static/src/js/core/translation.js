...
noblecrm.define('web.translation', function (require) {
"use strict";
...
var TranslationDataBase = Class.extend(/** @lends instance.TranslationDataBase# */{
    ...
    /**
        Loads the translations from an NobleCRMerp server.

        @param {noblecrmerp.Session} session The session object to contact the server.
