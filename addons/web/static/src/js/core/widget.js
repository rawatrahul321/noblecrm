noblecrm.define('web.Widget', function (require) {
"use strict";
 ...
 *
 *     var MyWidget = noblecrmerp.base.Widget.extend({
...
var Widget = core.Class.extend(mixins.PropertiesMixin, ServicesMixin, {
     ...
     *
     * @param {noblecrmerp.Widget} parent Binds the current instance to the given Widget instance.
