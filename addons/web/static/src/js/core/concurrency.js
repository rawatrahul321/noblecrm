noblecrm.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in NobleCRM.
 *
 * The basic concurrency primitives in NobleCRM JS are the callback, and the
...
return {
    ...
    /**
     * A (NobleCRM) mutex is a primitive for serializing computations.  This is
