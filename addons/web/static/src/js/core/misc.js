noblecrm.define('web.framework', function (require) {
"use strict";
...
if ($.blockUI) {
    ...
    $.blockUI.defaults.message = '<div class="noblecrmerp oe_blockui_spin_container" style="background-color: transparent;">';
...
//  * If params.wait, reload will wait the noblecrmerp server to be reachable before reloading
