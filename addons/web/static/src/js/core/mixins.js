noblecrm.define('web.mixins', function (require) {
"use strict";
...
function NobleCRMEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
NobleCRMEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

NobleCRMEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
     ...
     * NobleCRMerp Web where developers may want to replace existing callbacks with
     * theirs.
     *
    ...
    trigger_up: function (name, info) {
        var event = new NobleCRMEvent(this, name, info);
...
noblecrm.define('web.ServicesMixin', function (require) {
"use strict";
