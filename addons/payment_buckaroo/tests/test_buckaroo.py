...
from noblecrm.addons.payment_buckaroo.controllers.main import BuckarooController
from noblecrm.tools import mute_logger


@noblecrm.tests.common.at_install(False)
@noblecrm.tests.common.post_install(False)
...
class BuckarooForm(BuckarooCommon):
    ...
    @mute_logger('noblecrm.addons.payment_buckaroo.models.payment', 'ValidationError')
    def test_20_buckaroo_form_management(self):
        ...
        buckaroo_post_data = {
            ...
            'BRQ_SERVICE_PAYPAL_PAYEREMAIL': u'fhe@infonoble.com',
