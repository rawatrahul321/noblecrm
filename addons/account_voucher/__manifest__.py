...
=====================================================
The specific and easy-to-use Invoicing system in NobleCRM allows you to keep track of your accounting, even when you are not an accountant. It provides an easy way to follow up on your vendors and customers. 
...
* Voucher Payment [Customer & Vendors]
    ...
    'category': 'Accounting',
    'sequence': 20,
    'website' : 'https://www.infonoble.com/page/billing',
    'depends' : ['account'],
    'demo' : [],
    'data' : [
