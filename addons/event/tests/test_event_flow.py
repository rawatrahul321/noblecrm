...
from noblecrm.addons.event.tests.common import TestEventCommon
from noblecrm.exceptions import ValidationError, UserError, AccessError
from noblecrm.tools import mute_logger
from noblecrm.fields import Datetime
try:
...
class TestEventFlow(TestEventCommon):
    ...
    def test_event_date_range(self):
        self.patcher = patch('noblecrm.addons.event.models.event.fields.Datetime', wraps=Datetime)
