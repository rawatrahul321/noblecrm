...
from noblecrm.exceptions import Warning
from noblecrm.tools import pycompat, DEFAULT_SERVER_DATE_FORMAT
...
class AccountFrFec(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # but NobleCRM has the label on the account.move.line, so that's a
        # problem !
