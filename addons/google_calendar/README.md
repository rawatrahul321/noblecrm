...
forget an event, fully synchronized with the NobleCRM <a href="https://www.infonoble.com/page/crm">ERP Software CRM</a>.
...
You can ask to have a alarm of type 'notification' in your NobleCRM.  You will have
a notification in you NobleCRM which ever the page you are.

Google Calendar
---------------

With the plugin Google\_calendar, you can synchronize your NobleCRM calendar with Google Calendar.
