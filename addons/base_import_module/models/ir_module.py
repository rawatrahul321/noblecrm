...
from noblecrm.modules import load_information_from_description_file
from noblecrm.tools import convert_file, exception_to_unicode, pycompat
from noblecrm.tools.osutil import tempdir
    ...
    def import_zipfile(self, module_file, force=False):
        ...
        with zipfile.ZipFile(module_file, "r") as z:
            ...
            with tempdir() as module_dir:
                import noblecrm.modules.module as module
                try:
