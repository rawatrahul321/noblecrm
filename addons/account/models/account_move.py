...
from noblecrm.exceptions import RedirectWarning, UserError, ValidationError
from noblecrm.tools.misc import formatLang, format_date
from noblecrm.tools import float_is_zero, float_compare
...
class AccountMoveLine(models.Model):
    ...
    def create(self, vals):
        ...
        if context.get('apply_taxes') and vals.get('tax_ids'):
            # Get ids from triplets : https://www.infonoble.com/documentation/10.0/reference/orm.html#noblecrm.models.Model.write
