...
from noblecrm.addons.hw_proxy.controllers import main as hw_proxy
...
<html>
    <head>
        <title>NobleCRM's PosBox - Software Upgrade</title>
	...
	<p></p>
        ...
        the <a href='http://nightly.infonoble.com/trunk/posbox/'>latest image</a>. The upgrade
        procedure is explained into to the
        <a href='https://www.infonoble.com/documentation/user/point_of_sale/posbox/index.html'>PosBox manual</a>
        </p>
        <p>
        ...
        <pre>
"""
upgrade_template += subprocess.check_output("git --work-tree=/home/pi/noblecrm/ --git-dir=/home/pi/noblecrm/.git log -1", shell=True).decode('utf-8').replace("\n", "<br/>")
upgrade_template += """
        </pre>
        <div class='centering'>
...
class PosboxUpgrader(hw_proxy.Proxy):
    ...
    def perform_upgrade(self):
        ...
        os.system('/home/pi/noblecrm/addons/point_of_sale/tools/posbox/configuration/posbox_update.sh')
