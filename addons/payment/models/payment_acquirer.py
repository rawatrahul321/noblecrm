...
from noblecrm import api, exceptions, fields, models, _
from noblecrm.tools import consteq, float_round, image_resize_images, image_resize_image, ustr
from noblecrm.addons.base.module import module
...
class PaymentAcquirer(models.Model):
    ...
    NobleCRMerp and the acquirer. It generally consists in return urls given to the
    ...
    capture_manually = fields.Boolean(string="Capture Amount Manually",
        help="Capture the amount from NobleCRM, when the delivery is completed.")
