...
from noblecrm import exceptions
from noblecrm.http import Controller, request, route
from noblecrm.addons.bus.models.bus import dispatch
...
class BusController(Controller):
    """ Examples:
    noblecrmerp.jsonRpc('/longpolling/poll','call',{"channels":["c1"],last:0}).then(function(r){console.log(r)});
    noblecrmerp.jsonRpc('/longpolling/send','call',{"channel":"c1","message":"m1"});
    noblecrmerp.jsonRpc('/longpolling/send','call',{"channel":"c2","message":"m2"});
    """
