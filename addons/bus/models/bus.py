...
import noblecrm
from noblecrm import api, fields, models, SUPERUSER_ID
from noblecrm.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
...
class ImDispatch(object):
    ...
    def poll(self, dbname, channels, last, options=None, timeout=TIMEOUT):
        ...
        if not noblecrm.evented:
            ...
            current.setName("noblecrmerp.longpolling.request.%s" % current.ident)
...
dispatch = None
if not noblecrm.multi_process or noblecrm.evented:
