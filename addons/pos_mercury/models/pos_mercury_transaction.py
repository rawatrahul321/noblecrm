...
from noblecrm import models, api, service
from noblecrm.tools.translate import _
from noblecrm.exceptions import UserError
from noblecrm.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "NobleCRM " + service.common.exp_version()['server_version']
