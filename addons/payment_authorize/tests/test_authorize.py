...
from noblecrm.addons.payment_authorize.controllers.main import AuthorizeController
from noblecrm.tools import mute_logger


@noblecrm.tests.common.at_install(True)
...
class AuthorizeForm(AuthorizeCommon):
    ...
    @mute_logger('noblecrm.addons.payment_authorize.models.payment', 'ValidationError')
    ...
    def test_30_authorize_s2s(self):
        ...
        # add credential
        # FIXME: put this test in master-nightly on noblecrm/noblecrm + create sandbox account
        authorize.write({
