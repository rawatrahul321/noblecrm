...
from noblecrm.addons.portal.controllers.portal import get_records_pager, CustomerPortal, pager as portal_pager
from noblecrm.tools import groupby as groupbyelem

from noblecrm.osv.expression import OR
