...
from noblecrm.tests.common import TransactionCase, can_import
from noblecrm.modules.module import get_module_resource
from noblecrm.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('noblecrm.addons.base_import.models.base_import')
