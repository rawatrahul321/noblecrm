...
class FetchmailServer(models.Model):
    ...
    script = fields.Char(readonly=True, default='/mail/static/scripts/noblecrmerp_mailgate.py')
    ...
    def onchange_server_type(self):
        ...
        self.configuration = """
            ...
            noblecrmerp_mailgate.py --host=HOSTNAME --port=PORT -u %(uid)d -p PASSWORD -d %(dbname)s
            Example configuration for the postfix mta running locally:
            /etc/postfix/virtual_aliases:
            @youdomain noblecrmerp_mailgate@localhost
            /etc/aliases:
            noblecrmerp_mailgate: "|/path/to/noblecrmerp-mailgate.py --host=localhost -u %(uid)d -p PASSWORD -d %(dbname)s"
        """ % conf
